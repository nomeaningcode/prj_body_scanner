...
namespace prjBodyScanner.Clases
{
    class GenerarPassword
    {
        ...
        string caracteres = "abcdefghijklmnorstuvwxyz";
        string numeros = "0123456789";
        string simbolos = "9acl34x5";
        ...
        public GenerarPassword(int longitudCaracteres)
        ...
        /// <exception cref="ArgumentOutOfRangeException">Se produce al intentar introducir
        /// un porcentaje de caracteres especiales mayor de 100</exception>
        public GenerarPassword(int longitudCaracteres, int porcentajeMayusculas, int porcentajeSimbolos, int porcentajeNumeros)
        {
        ...
        public static string GetPassword()
        {
            ...
            GenerarPassword gp = new GenerarPassword();
